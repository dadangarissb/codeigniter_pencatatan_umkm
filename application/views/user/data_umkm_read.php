    ...
    <div class="col-md-12">
        <div class="nav-tabs-custom">
          <div class="tab-content" style="background-color:skyblue">
                <body>
                  <h4 align="center" style="font-size:16pt"><b> Profil Lengkap <br>Usaha Mikro Kecil Menengah (UMKM) </b></h4>                
                </body>
            </div>
          </div>
      ...
      <div class="box box-success">
        <div class="box-header with-border" align="center">
          <div class="btn-group-vertical">
            <?php
		        echo anchor(site_url('C_User/Update/'.$dataumkm['id_umkm']),'Edit Profile','class="btn btn-warning btn-flat"'); 
            echo anchor(site_url('C_User/show/'.$dataumkm['id_umkm']),'Gambar Produk','class="btn btn-success btn-flat"'); 
            echo anchor(site_url('C_DataUmkm/Cetak/'.$dataumkm['id_umkm']),'Cetak Data','class="btn btn-info btn-flat" '); 
            echo anchor(site_url('C_Login/Logout'),'Logout','class="btn btn-danger btn-flat" '); 
             ?>
          </div>
        </div>
      </div>
          ...
          <div class="tab-content">
            <div class="active tab-pane" id="activity">
                  ...
                  <p>
		              ...
		              <p align="center">
		              <?php
		              echo anchor(site_url('c_user/create_data_usaha/'.$dataumkm['id_umkm']),'Tambah Data Tahunan','class="btn btn-success btn-flat"'); 
			             ?>
			            </p>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <div class="btn-group">
    			                <?php 
                    			echo anchor(site_url('C_User/update_data_usaha/'.$c_datausaha->id_data_usaha),'Edit','class="btn btn-info btn-flat"'); 
