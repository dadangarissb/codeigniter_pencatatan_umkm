              ...
              <form role="form">
               <div class="box-body">
                ...
                <div class="row top-margin">
                  <div class="col-sm-6">
                    <label> <span class="text-danger"> <?php echo form_error('password') ?></span></label>
                    <input type="hidden" class="form-control" name="pass1" placeholder="Password" onChange="cekPass();" value="<?php echo $pass2; ?>">
                  </div>
                  <div class="col-sm-6">
                    <label> <span class="text-danger"></span></label>
                    <input type="hidden" name="pass2" class="form-control" placeholder="Konfirmasi Password" onChange="cekPass();" value="<?php echo $pass2; ?>">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  foreach($kelurahan as $row)
                      ...
                      echo form_dropdown('id_kelurahan', $options, $id_kelurahan, 'class="form-control" ');
                      ?>
                </div>
                ...
                <div class="form-group">
                  ...
                  foreach($jenis as $row)
                      ...
                      echo form_dropdown('id_jenis_usaha', $options2, $id_jenis_usaha, 'class="form-control" ');
                      ?>
                </div>
