          ...
          <div class="tab-content">
            <div class="active tab-pane" id="activity">
                <body>
                  ...
                  <p align="center">
                  <?php
                  echo anchor (site_url('upload/add/'.$row['id_umkm']),'Tambah Foto','class="btn btn-success btn-flat"');

                  echo anchor (site_url('C_DataUmkm/read/'.$row['id_umkm']),'Kembali','class="btn btn-warning btn-flat"');
      ...
      <div class="col-sm-6 col-xs-6">
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <p><?php  echo anchor(site_url('upload/delete/'.$rowdata->id_foto),'Hapus Gambar','class="btn btn-danger btn-flat"','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
        ?></p>
            <p></p>
